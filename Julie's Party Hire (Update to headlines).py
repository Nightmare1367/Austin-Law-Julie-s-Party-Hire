"""
Date Created: 13 / 06 / 2022 (13th June)
...
def printing_details():
    ...
    details_count = 0
    Label(frame, text = "Row", font = "Ariel 10 bold").grid(column = 0, row = 9)
    Label(frame, text = "| Customer Name", font = "Ariel 10 bold").grid(column = 1, row = 9)
    Label(frame, text = "| Receipt Number", font = "Ariel 10 bold").grid(column = 2, row = 9)
    Label(frame, text = "| Item Hired", font = "Ariel 10 bold").grid(column = 3, row = 9)
    Label(frame, text = "| Amount Hired", font = "Ariel 10 bold").grid(column = 4, row = 9)
...
def setup_buttons():
    ...
    item_entry = StringVar()                                    # Combo Box for the item hired
    ComboBox = ttk.Combobox(main_window, textvariable = item_entry, state = "readonly", value = ("Plates", "Chairs", "Foldable Tables", "Silverware", "Glassware"
                                                                                                 , "Balloons", "Table Cloths")).grid(column = 1, row = 4, sticky = W+E)
    itemnum_entry = StringVar()                                 # Spin Box for the amount hired
